...
struct Music_iOS_App_Section_Quiz_Three: View {
    ...
    let questions = [
        ...
        Question(text: "What is the order of chords in a key?", answers: ["Major, Minor, Minor, Major, Major, Minor, Diminished",
                                                                         "Major, Major, Minor, Major, Major, Minor, Diminished",
                                                                         "Major, Minor, Minor, Major, Major, Minor, Minor"],
                 correctAnswer: "Major, Minor, Minor, Major, Major, Minor, Diminished"),
    ...
    var body: some View {
        ...
        // Respect safe areas so we don’t overlap the tab bar
        .padding(.bottom, 20)
